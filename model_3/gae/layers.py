...
class InnerProductDecoder(Layer):
    ...
    def __init__(self, num_nodes,
        ...
        self.popularity_weight = get_weight_init_by_name(init_name=weight_init,
                                                         input_dim=1,
                                                         output_dim=num_nodes,
                                                         name="popularity_weights")
        self.productivity_weight = get_weight_init_by_name(init_name=weight_init,
                                                           input_dim=num_nodes,
                                                           output_dim=1,
                                                            name="productivity_weight")
