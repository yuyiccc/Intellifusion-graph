...
def train_and_test(config):
    ...
    if config['model'] == 'ae':
        ...
        model = GCNModelVAE(placeholders, num_nodes, config=config, num_features=num_features)
    ...
    for epoch in range(config['epochs']):
        ...
        outs = sess.run([opt.opt_op, opt.loss, opt.preds, opt.labels], feed_dict=feed_dict)
...
if __name__ == '__main__':
    ...
    config['result_name'] = 'test_vae.csv'
